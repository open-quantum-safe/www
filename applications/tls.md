...
- [OQS-OpenSSL provider version 0.8.0](https://github.com/open-quantum-safe/oqs-provider/releases/tag/0.8.0) aligned with liboqs 0.12.0 (December 24, 2024) <span class="label label-green">current version</span>
